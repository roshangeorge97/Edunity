...
function Home() {
  return (
    ...
    <div className="relative overflow-hidden bg-black">
      <div className="flex pt-16 pb-0 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <div>
            <div className="mt-10">
              ...
              <a
                href="/mentors"
                className="inline-block rounded-md border border-transparent bg-yellow py-3 px-8 text-center font-medium text-white hover:bg-green hover:text-yellow"
              >
                Find Mentor
              </a>
            </div>
    ...
    <div className="bg-yellow">
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
        <h2 className="text-3xl font-bold tracking-tight text-black sm:text-4xl">
          <span className="block">Want to Register as Mentor?</span>
