...
<div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
  {products.map((product) => (
    <div key={product.id} className="group bg-black p-4 rounded-lg text-yellow">
...
<h3 className=" text-lg font-medium text-gray-700 m-1">{product.name}</h3>
<p className="text-lg font-medium text-gray-900 m-1">{product.price}</p>
</div>
                <div className="relative">
 <button onClick={() => setIsDialogOpen(true)} className="bg-green text-black font-medium py-2 px-4 rounded-lg hover:bg-green-600">Add to cart</button>
 <a href="/view"><button className="ml-5 bg-green text-black font-medium py-2 px-4 rounded-lg hover:bg-green-600">View</button></a>
